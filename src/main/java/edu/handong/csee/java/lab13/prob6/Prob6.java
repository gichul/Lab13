...
public class Prob6 {//declare Prob6 class
	...
	public static void main(String[] args) {//main method
		...
		Printer.print(p1);		//input the data p1 to Printer static class 
		Printer.print(p2);		//input the data p2 to Printer static class 
		Printer.print(p3);		//input the data p3 to Printer static class 
		Printer.print(p4);		//input the data p4 to Printer static class 
	}
}
